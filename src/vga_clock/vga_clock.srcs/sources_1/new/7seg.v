 ...
 *
 *              El multiplexado cicla entre los ocho displays a 762 Hz totales
 *              usando los bits [16:14] de un contador de 17 bits, lo que da
 *              un tiempo de encendido de 163 us por digito sin parpadeo visible.
 *
 * Puertos:
 *   clk    Reloj del sistema 100 MHz
 *   rst    Reset síncrono activo alto
 *   hour   Hora actual, rango 1-12
 *   minute Minuto actual, rango 0-59
 *   second Segundo actual, rango 0-59
 *   seg    Segmentos activos en bajo, orden {CG,CF,CE,CD,CC,CB,CA}
 *   an     Anodos activos en bajo, an[7] es el display mas a la izquierda
